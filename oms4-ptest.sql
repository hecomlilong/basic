...
CREATE TABLE IF NOT EXISTS `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='开户信息表' AUTO_INCREMENT=8702 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='空白合同' AUTO_INCREMENT=15976 ;
...
CREATE TABLE IF NOT EXISTS `cache_dashboard` (
  ...
  `create_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='驾驶舱缓存数据' AUTO_INCREMENT=44362 ;
...
CREATE TABLE IF NOT EXISTS `cache_day` (
  ...
  KEY `isRenew` (`isRenew`),
  KEY `yeji` (`yeji`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='业务员工作统计表-缓存数据-每天' AUTO_INCREMENT=661142 ;
...
CREATE TABLE IF NOT EXISTS `calllog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用友电话记录' AUTO_INCREMENT=475 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10263819 ;
...
CREATE TABLE IF NOT EXISTS `callrecord_latest` (
  ...
  KEY `index_name` (`linkstatus`),
  KEY `operator` (`operator`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='电话记录表' AUTO_INCREMENT=68036 ;
...
CREATE TABLE IF NOT EXISTS `conference_meeting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='PC端电话录入增加选项“邀请会议"需求' AUTO_INCREMENT=14 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=22317 ;
...
CREATE TABLE IF NOT EXISTS `contracts_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='合同费用类型表' AUTO_INCREMENT=29345 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=53151 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='合同应收账款-按月拆分表' AUTO_INCREMENT=294454 ;
...
CREATE TABLE IF NOT EXISTS `contract_money` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同回款记录' AUTO_INCREMENT=16821 ;
...
CREATE TABLE IF NOT EXISTS `cusinorout` (
  ...
  KEY `day` (`day`),
  KEY `userid_2` (`userid`,`day`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='业务员拉入客户每天统计表' AUTO_INCREMENT=1642 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2243224 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='客户参加会议表' AUTO_INCREMENT=33 ;
...
CREATE TABLE IF NOT EXISTS `customer_operate` (
  ...
  PRIMARY KEY (`oid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10357 ;
...
CREATE TABLE IF NOT EXISTS `customer_throwlog` (
  ...
  KEY `type` (`type`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='客户扔回公海日志表' AUTO_INCREMENT=9646237 ;
...
CREATE TABLE IF NOT EXISTS `customer_v30log` (
  ...
  KEY `type` (`type`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='客户同步日志表' AUTO_INCREMENT=3860667 ;
...
CREATE TABLE IF NOT EXISTS `elastic_test` (
  ...
  PRIMARY KEY (`id`),
  KEY `ctime` (`ctime`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='elasticsearch测试表' AUTO_INCREMENT=19209 ;
...
CREATE TABLE IF NOT EXISTS `forecast` (
  ...
  PRIMARY KEY (`id`),
  KEY `cusid` (`cusid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=22202 ;
...
CREATE TABLE IF NOT EXISTS `forecast_day` (
  ...
  KEY `ownerid` (`ownerid`),
  KEY `vwarid` (`vwarid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='回款预测-天' AUTO_INCREMENT=3922 ;
...
CREATE TABLE IF NOT EXISTS `forecast_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='回款预测操作日志' AUTO_INCREMENT=39631 ;
...
CREATE TABLE IF NOT EXISTS `lidan` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='理单表' AUTO_INCREMENT=113817 ;
...
CREATE TABLE IF NOT EXISTS `lidan_follow` (
  ...
  `notrenew` text NOT NULL COMMENT '不续费原因',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='理单跟进历史表' AUTO_INCREMENT=42839 ;
...
CREATE TABLE IF NOT EXISTS `omslogs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=331683 ;
...
CREATE TABLE IF NOT EXISTS `oms_data_project` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='OMS数据项目配置表' AUTO_INCREMENT=45 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='OMS数据项目时间记录表' AUTO_INCREMENT=384 ;
...
CREATE TABLE IF NOT EXISTS `open_apply_contract` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同申请开户或开通产品日志表' AUTO_INCREMENT=72 ;
...
CREATE TABLE IF NOT EXISTS `performance_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4719 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3544957 ;
...
CREATE TABLE IF NOT EXISTS `renew_action_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='续签操作客户历史记录表' AUTO_INCREMENT=1927 ;
...
CREATE TABLE IF NOT EXISTS `renew_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='续签配置详情' AUTO_INCREMENT=1117 ;
...
CREATE TABLE IF NOT EXISTS `renew_training_report` (
  ...
  PRIMARY KEY (`id`),
  KEY `cusid` (`cusid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='续签培训报告' AUTO_INCREMENT=104 ;
...
CREATE TABLE IF NOT EXISTS `returnedmoney` (
  ...
  KEY `vwarid` (`vwarid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12530 ;
...
CREATE TABLE IF NOT EXISTS `todo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='待办事项' AUTO_INCREMENT=315 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='闭环销售－客户表' AUTO_INCREMENT=7 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='闭环销售订单' AUTO_INCREMENT=29 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='闭环销售－支付日志' AUTO_INCREMENT=32 ;
...
CREATE TABLE IF NOT EXISTS `vipcustomer_paylognotify` (
  ...
  PRIMARY KEY (`id`),
  KEY `vp_orderid` (`vp_orderid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='支付宝支付备份日志信息' AUTO_INCREMENT=40 ;

-- --------------------------------------------------------

--
-- 表的结构 `vipcustomer_sendemaillog`
--

CREATE TABLE IF NOT EXISTS `vipcustomer_sendemaillog` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `vs_customerid` int(11) unsigned NOT NULL COMMENT '客户ID',
  `vs_email` varchar(200) NOT NULL COMMENT '客户邮箱',
  `vs_realname` varchar(100) NOT NULL DEFAULT '' COMMENT '发送给的姓名',
  `vs_subject` varchar(1000) NOT NULL DEFAULT '' COMMENT '邮件题目',
  `vs_body` varchar(6000) NOT NULL DEFAULT '' COMMENT '邮件内容',
  `vs_sendstatus` tinyint(4) NOT NULL DEFAULT '-1' COMMENT '发送情况，－1:未发送；0：发送失败；1-发送成功',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='发送邮件日志' AUTO_INCREMENT=97 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='闭环销售日志表' AUTO_INCREMENT=108 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='分享内容表' AUTO_INCREMENT=75 ;
...
CREATE TABLE IF NOT EXISTS `visitrecord` (
  ...
  KEY `operator` (`operator`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=239490 ;
