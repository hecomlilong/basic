...
--
-- 主机: 10.44.163.174:3306
-- 生成日期: 2016-07-28 11:48:14
-- 服务器版本: 5.7.12-log
-- PHP 版本: 5.3.3
...
CREATE TABLE IF NOT EXISTS `access_token` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='访问会话控制' AUTO_INCREMENT=2005 ;
...
CREATE TABLE IF NOT EXISTS `account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='开户信息表' AUTO_INCREMENT=9766 ;
...
CREATE TABLE IF NOT EXISTS `advice_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='建议评论表' AUTO_INCREMENT=643 ;
...
CREATE TABLE IF NOT EXISTS `advice_team` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='团队建设建议表' AUTO_INCREMENT=45 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='空白合同' AUTO_INCREMENT=17031 ;
...
CREATE TABLE IF NOT EXISTS `blankcontract_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='空白合同-合同编号前缀' AUTO_INCREMENT=83 ;
...
CREATE TABLE IF NOT EXISTS `cache_active_day` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=43973 ;
...
CREATE TABLE IF NOT EXISTS `cache_dashboard` (
  ...
  `create_time` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_position_regionid` (`position`,`regionid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='驾驶舱缓存数据' AUTO_INCREMENT=38612 ;
...
CREATE TABLE IF NOT EXISTS `cache_day` (
  ...
  `cusin` int(11) NOT NULL DEFAULT '0',
  `cusout` int(11) NOT NULL DEFAULT '0',
  ...
  `isRenew` tinyint(1) NOT NULL COMMENT '是否续签',
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`),
  KEY `day` (`day`),
  KEY `userid_2` (`userid`,`day`),
  KEY `idx_lasttime` (`lasttime`),
  KEY `idx_area_id_day` (`area_id`,`day`),
  KEY `idx_deptid_day` (`deptid`,`day`),
  KEY `idx_day_userid` (`day`,`userid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='业务员工作统计表-缓存数据-每天' AUTO_INCREMENT=612641 ;
...
CREATE TABLE IF NOT EXISTS `cache_day_leader` (
  ...
  KEY `day` (`day`),
  KEY `userid_2` (`userid`,`day`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='leader工作统计表-缓存数据-每天' AUTO_INCREMENT=2111 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='预测与回款缓存表-day' AUTO_INCREMENT=120377 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='预测与回款缓存表-month' AUTO_INCREMENT=6981 ;

-- --------------------------------------------------------

--
-- 表的结构 `cache_forecast_month_bak2`
--

CREATE TABLE IF NOT EXISTS `cache_forecast_month_bak2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ownerid` int(11) NOT NULL COMMENT '用户ID',
  `realname` varchar(30) NOT NULL COMMENT '用户姓名',
  `area_id` int(11) NOT NULL COMMENT '区域或战区ID',
  ...
  KEY `month` (`month`),
  KEY `ownerid_2` (`ownerid`,`month`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='预测与回款缓存表-month' AUTO_INCREMENT=6638 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='预测与回款缓存表-week' AUTO_INCREMENT=18152 ;
...
CREATE TABLE IF NOT EXISTS `cache_month` (
  ...
  KEY `yeji` (`yeji`),
  KEY `area_id` (`area_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='业务员工作统计表-缓存数据-月度' AUTO_INCREMENT=27035 ;
...
CREATE TABLE IF NOT EXISTS `cache_org` (
  ...
  `yeji` int(11) NOT NULL COMMENT '业绩',
  `yqwh` int(11) NOT NULL COMMENT '已签未回',
  `zdgj` int(11) NOT NULL COMMENT '重点跟进',
  `nqnh` int(11) NOT NULL COMMENT '能签能回',
  `cjkh` int(11) NOT NULL COMMENT '冲击客户',
  `yskh` int(11) NOT NULL COMMENT '已死客户',
  `dld` int(11) NOT NULL COMMENT '待理单',
  PRIMARY KEY (`id`),
  KEY `org` (`org`),
  KEY `month` (`month`),
  KEY `month_2` (`month`,`org`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='每一个组织架构每月的业绩' AUTO_INCREMENT=3606 ;
...
CREATE TABLE IF NOT EXISTS `calllog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用友电话记录' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10721577 ;
...
CREATE TABLE IF NOT EXISTS `callrecording` (
  ...
  `oss_recordurl` varchar(255) NOT NULL COMMENT '存储在OSS上的录音地址',
  `oss_times` int(11) NOT NULL COMMENT '转存的次数',
...
CREATE TABLE IF NOT EXISTS `callrecord_latest` (
  ...
  KEY `index_name` (`linkstatus`),
  KEY `operator` (`operator`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='电话记录表' AUTO_INCREMENT=485567 ;
...
CREATE TABLE IF NOT EXISTS `cockpit_cache` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(11) NOT NULL COMMENT '缓存数据所属用户id',
  `data` longtext COMMENT '缓存数据get_target_data',
  `data2` longtext COMMENT '缓存数据get_visit_data',
  `data3` longtext COMMENT '缓存数据get_duibi_data',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `conference_meeting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='PC端电话录入增加选项“邀请会议"需求' AUTO_INCREMENT=11 ;
...
CREATE TABLE IF NOT EXISTS `configlist` (
  ...
  `isnew` tinyint(1) NOT NULL COMMENT '是否续签',
  `del` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_type` (`type`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=70265 ;
...
CREATE TABLE IF NOT EXISTS `contracts` (
  ...
  `type` int(11) DEFAULT NULL COMMENT '合同类型  1新签  2续费',
  ...
  `new_product_class` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '产品分类，0-红圈营销；1-红圈管理',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=23148 ;

-- --------------------------------------------------------

--
-- 表的结构 `contracts_bak20151214`
--

CREATE TABLE IF NOT EXISTS `contracts_bak20151214` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cusid` int(11) DEFAULT NULL COMMENT '客户ID',
  `cusname` varchar(128) DEFAULT NULL COMMENT '客户原始名称',
  `org_cusid` int(11) NOT NULL,
  ...
  KEY `userid` (`ownerid`),
  KEY `customerid` (`cusid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=16454 ;

-- --------------------------------------------------------

--
-- 表的结构 `contracts_bak_20141222`
--

CREATE TABLE IF NOT EXISTS `contracts_bak_20141222` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cusid` int(11) DEFAULT NULL COMMENT '客户ID',
  `cusname` varchar(128) DEFAULT NULL COMMENT '客户原始名称',
  `org_cusid` int(11) NOT NULL,
  ...
  `bl_user` int(11) NOT NULL COMMENT '补录人',
  `returnmoney_flg` tinyint(1) NOT NULL COMMENT '是否已有回款：0否1是',
  `returnmoney` varchar(10) NOT NULL COMMENT '回款总额',
  `income_month_flg` tinyint(1) NOT NULL COMMENT '应收款项是否已按月份拆分:0否1是',
  `del` tinyint(1) NOT NULL COMMENT '是否已删除：0否1是',
  `input_flg` tinyint(1) NOT NULL COMMENT '是否已录入，0否1是',
  `input_uid` int(11) NOT NULL COMMENT '录入人ID',
...
CREATE TABLE IF NOT EXISTS `contracts_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同服务-设备基础数据表' AUTO_INCREMENT=70 ;
...
CREATE TABLE IF NOT EXISTS `contracts_config_new` (
  ...
  `name` varchar(90) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同服务-设备基础数据表' AUTO_INCREMENT=12 ;
...
CREATE TABLE IF NOT EXISTS `contracts_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同费用类型表' AUTO_INCREMENT=30873 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=55689 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同应收账款-按月拆分表' AUTO_INCREMENT=308609 ;
...
CREATE TABLE IF NOT EXISTS `contract_money` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同回款记录' AUTO_INCREMENT=17858 ;
...
CREATE TABLE IF NOT EXISTS `contract_money_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='回款详细分拆表' AUTO_INCREMENT=3577 ;
...
CREATE TABLE IF NOT EXISTS `cursor_msgid` (
  ...
  PRIMARY KEY (`id`),
  KEY `user` (`user`,`msgid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='微信发送给我方的消息ID记录表' AUTO_INCREMENT=25 ;
...
CREATE TABLE IF NOT EXISTS `cusinorout` (
  ...
  KEY `userid_2` (`userid`,`day`),
  KEY `type` (`type`),
  KEY `idx_typ_cusid` (`type`,`cusid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='业务员拉入客户每天统计表' AUTO_INCREMENT=2056623 ;
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `follow_type` tinyint(1) NOT NULL DEFAULT '-1' COMMENT '最新的跟进状态',
  `source` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '客户来源，默认为0，1为内部商机客户，2为外部商机客户',
  `pullTime` datetime DEFAULT NULL COMMENT '进入私海时间',
  `renew_status` smallint(6) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2375112 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='客户评论表' AUTO_INCREMENT=35 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='客户参加会议表' AUTO_INCREMENT=516 ;
...
CREATE TABLE IF NOT EXISTS `customer_new` (
  ...
  KEY `area` (`area`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='批量导入新客户表' AUTO_INCREMENT=43311 ;
...
CREATE TABLE IF NOT EXISTS `customer_open` (
  ...
  `try_times` int(11) NOT NULL DEFAULT '0' COMMENT '弃用   2016年07月01日18:51:34',
...
CREATE TABLE IF NOT EXISTS `customer_operate` (
  ...
  PRIMARY KEY (`oid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12926 ;
...
CREATE TABLE IF NOT EXISTS `customer_throwlog` (
  ...
  KEY `type` (`type`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='客户扔回公海日志表' AUTO_INCREMENT=10831127 ;
...
CREATE TABLE IF NOT EXISTS `customer_v30log` (
  ...
  KEY `type` (`type`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='客户同步日志表' AUTO_INCREMENT=3821698 ;
...
CREATE TABLE IF NOT EXISTS `dayreport_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `c_vwar` (`c_vwar`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='手机端日报' AUTO_INCREMENT=5309 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11333 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='红圈钉钉客户分配日志表' AUTO_INCREMENT=8135 ;
...
CREATE TABLE IF NOT EXISTS `elastic_test` (
  ...
  PRIMARY KEY (`id`),
  KEY `ctime` (`ctime`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='elasticsearch测试表' AUTO_INCREMENT=36576 ;
...
CREATE TABLE IF NOT EXISTS `file_list` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='产品文件清单' AUTO_INCREMENT=13 ;
...
CREATE TABLE IF NOT EXISTS `forecast` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_cusid` (`cusid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=28863 ;
...
CREATE TABLE IF NOT EXISTS `forecast_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='预测评论表' AUTO_INCREMENT=2748 ;
...
CREATE TABLE IF NOT EXISTS `forecast_day` (
  ...
  KEY `ownerid` (`ownerid`),
  KEY `vwarid` (`vwarid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='回款预测-天' AUTO_INCREMENT=4595 ;
...
CREATE TABLE IF NOT EXISTS `forecast_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='回款预测操作日志' AUTO_INCREMENT=52310 ;
...
CREATE TABLE IF NOT EXISTS `forecast_month` (
  ...
  KEY `ownerid` (`ownerid`),
  KEY `vwarid` (`vwarid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='回款预测-月' AUTO_INCREMENT=4692 ;
...
CREATE TABLE IF NOT EXISTS `forecast_week` (
  ...
  KEY `ownerid` (`ownerid`),
  KEY `vwarid` (`vwarid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='回款预测-周' AUTO_INCREMENT=6422 ;
...
CREATE TABLE IF NOT EXISTS `helpvideo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='帮助视频' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `imageresolution` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1008767 ;
...
CREATE TABLE IF NOT EXISTS `invoice` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9823 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3220 ;

-- --------------------------------------------------------

--
-- 表的结构 `invoice_bak20151214`
--

CREATE TABLE IF NOT EXISTS `invoice_bak20151214` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `cusid` int(11) NOT NULL COMMENT '公司iD',
  `cusname` varchar(200) NOT NULL COMMENT '开票单位名称',
  ...
  `is_relevance` smallint(5) NOT NULL DEFAULT '0' COMMENT '0:未关联  1：已关联',
  `del` tinyint(1) NOT NULL DEFAULT '0',
  `send_time` datetime NOT NULL COMMENT '邮寄时间',
  `send_sn` varchar(30) NOT NULL COMMENT '快递单号',
  `send_uid` int(11) NOT NULL COMMENT '邮寄人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6577 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5313 ;
...
CREATE TABLE IF NOT EXISTS `invoice_pro` (
  ...
  `del` tinyint(1) NOT NULL COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5640 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5160 ;
...
CREATE TABLE IF NOT EXISTS `lidan` (
  ...
  `follow_type` tinyint(1) NOT NULL COMMENT '跟进类型：0待理单、1已签已回、2重点跟进、3能签能回、4冲击客户、5已死客户 6 已签未回',
  ...
  KEY `idx_ownerid` (`ownerid`),
  KEY `idx_cusid` (`cusid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='理单表' AUTO_INCREMENT=144195 ;
...
CREATE TABLE IF NOT EXISTS `lidan2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `do` tinyint(4) NOT NULL COMMENT '0新签，1续签',
  `cusid` int(11) NOT NULL COMMENT '客户ID',
  `ownerid` int(11) NOT NULL COMMENT '当前业务员ID',
  ...
  KEY `idx_ownerid` (`ownerid`),
  KEY `idx_cusid` (`cusid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='理单表' AUTO_INCREMENT=135622 ;
...
CREATE TABLE IF NOT EXISTS `lidan_follow` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_cusid` (`cusid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='理单跟进历史表' AUTO_INCREMENT=66071 ;
...
CREATE TABLE IF NOT EXISTS `month_ids` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='月初ID记录表' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `omslogs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_ownerid` (`ownerid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5601760 ;

-- --------------------------------------------------------

--
-- 表的结构 `omslogs20141215`
--

CREATE TABLE IF NOT EXISTS `omslogs20141215` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ownerid` int(11) DEFAULT NULL,
  `ip` char(15) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  ...
  `ipinfo` text,
  `ipinfobak` text NOT NULL,
  `type` int(11) DEFAULT '0' COMMENT '日志类型 1：登录日志   0：默认',
  `browser` char(50) DEFAULT NULL COMMENT '浏览器',
  `version` char(50) DEFAULT NULL COMMENT '浏览器版本号',
  `mobile` char(50) DEFAULT NULL COMMENT '终端名称',
  `allstring` char(255) DEFAULT NULL COMMENT '所有代理信息',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `oms_data_project` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='OMS数据项目配置表' AUTO_INCREMENT=41 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='OMS数据项目时间记录表' AUTO_INCREMENT=4073 ;
...
CREATE TABLE IF NOT EXISTS `open_apply` (
  ...
  `try_th` tinyint(4) DEFAULT NULL COMMENT '弃用  2016年07月01日18:51:09',
  ...
  `open_msg` varchar(100) NOT NULL DEFAULT '' COMMENT '开户返回的信息',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `open_apply_contract` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='合同申请开户或开通产品日志表' AUTO_INCREMENT=279 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4644 ;
...
CREATE TABLE IF NOT EXISTS `phonebook` (
  ...
  `cusname` varchar(128) DEFAULT NULL COMMENT '客户名称',
  `linkman` varchar(64) DEFAULT NULL COMMENT '联系人',
  `linkman_idx` varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `cusid` (`cusid`),
  FULLTEXT KEY `fdx_linkman` (`linkman_idx`),
  FULLTEXT KEY `fdx_pinyin` (`pinyin`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3707197 ;
...
CREATE TABLE IF NOT EXISTS `pk` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='PK表' AUTO_INCREMENT=746 ;
...
CREATE TABLE IF NOT EXISTS `pk_follow` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='PK跟注表' AUTO_INCREMENT=148 ;
...
CREATE TABLE IF NOT EXISTS `pk_month` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='PK表-月份子表' AUTO_INCREMENT=746 ;
...
CREATE TABLE IF NOT EXISTS `pk_obj` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='PK表-对象子表' AUTO_INCREMENT=1491 ;
...
CREATE TABLE IF NOT EXISTS `question` (
  ...
  `referer_type` tinyint(1) NOT NULL COMMENT '问题来源：1电话，2拜访，3培训',
  ...
  KEY `cate` (`cate`),
  KEY `status` (`status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='问题表' AUTO_INCREMENT=283 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=63409 ;
...
CREATE TABLE IF NOT EXISTS `renew_action_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `ctime` (`ctime`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='续签操作客户历史记录表' AUTO_INCREMENT=45388 ;
...
CREATE TABLE IF NOT EXISTS `renew_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='续签配置详情' AUTO_INCREMENT=13103 ;
...
CREATE TABLE IF NOT EXISTS `renew_training_report` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='续签培训报告' AUTO_INCREMENT=2461 ;
...
CREATE TABLE IF NOT EXISTS `repair` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='培训表' AUTO_INCREMENT=87 ;
...
CREATE TABLE IF NOT EXISTS `report_cache_stuff` (
  ...
  KEY `month` (`month`),
  KEY `userid_2` (`userid`,`month`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='业务员工作统计表-缓存数据' AUTO_INCREMENT=6512 ;

-- --------------------------------------------------------

--
-- 表的结构 `report_cache_stuff_bak20150226`
--

CREATE TABLE IF NOT EXISTS `report_cache_stuff_bak20150226` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(11) NOT NULL,
  `realname` varchar(60) NOT NULL COMMENT '冗余字段：业务员姓名',
  `area_id` int(11) NOT NULL COMMENT '区域或战区ID',
  ...
  KEY `month` (`month`),
  KEY `userid_2` (`userid`,`month`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='业务员工作统计表-缓存数据' AUTO_INCREMENT=6175 ;
...
CREATE TABLE IF NOT EXISTS `returnedmoney` (
  ...
  `edit_remark` text NOT NULL,
  `remit_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '回款渠道0直销1运营',
  `do` tinyint(1) NOT NULL COMMENT '0新签，1续签',
  PRIMARY KEY (`id`),
  KEY `pay_time` (`pay_time`),
  KEY `vwarid` (`vwarid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13654 ;
...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色表' AUTO_INCREMENT=45 ;
...
CREATE TABLE IF NOT EXISTS `seapush_assign_log` (
  ...
  KEY `areaid` (`areaid`),
  KEY `assigntime` (`assigntime`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='公海开放池客户分配日志表' AUTO_INCREMENT=39471 ;
...
CREATE TABLE IF NOT EXISTS `sendemaillogs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='PK表' AUTO_INCREMENT=216 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户手机端访问session表' AUTO_INCREMENT=3689 ;
...
CREATE TABLE IF NOT EXISTS `slavecheck` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='检查主从同步状态表' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `stat_staff_month` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=8689 ;
...
CREATE TABLE IF NOT EXISTS `synctask` (
  ...
  `ctime` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='同步计划表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `target` (
  ...
  `del` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='员工表' AUTO_INCREMENT=491 ;
...
CREATE TABLE IF NOT EXISTS `target_month_department` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='员工表' AUTO_INCREMENT=1933 ;
...
CREATE TABLE IF NOT EXISTS `todo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='待办事项' AUTO_INCREMENT=15305 ;
...
CREATE TABLE IF NOT EXISTS `train` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='培训表' AUTO_INCREMENT=6081 ;
...
CREATE TABLE IF NOT EXISTS `train_assign` (
  ...
  `train_uid` int(11) NOT NULL COMMENT '培训人ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='培训表-分配历史表' AUTO_INCREMENT=5007 ;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `dimiss_time` datetime DEFAULT '0000-00-00 00:00:00' COMMENT '离职日期',
  ...
  `token` varchar(255) NOT NULL DEFAULT '' COMMENT '返回给客户端token登入识别码',
  `token_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'token存入时间',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6278 ;

-- --------------------------------------------------------

--
-- 表的结构 `users_bak20150316`
--

CREATE TABLE IF NOT EXISTS `users_bak20150316` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(32) NOT NULL,
  `passwordbak` char(32) NOT NULL,
  `realname` varchar(16) NOT NULL,
...
--
-- 表的结构 `users_bak20151002`
--

CREATE TABLE IF NOT EXISTS `users_bak20151002` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(32) NOT NULL,
  `passwordbak` char(32) NOT NULL,
  `realname` varchar(16) NOT NULL,
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4427 ;

-- --------------------------------------------------------

--
-- 表的结构 `users_bak20160430`
--

CREATE TABLE IF NOT EXISTS `users_bak20160430` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(32) NOT NULL,
  `passwordbak` char(32) NOT NULL,
  `realname` varchar(16) NOT NULL,
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5942 ;
...
CREATE TABLE IF NOT EXISTS `vipcustomers` (
  ...
  `vc_entname` varchar(300) NOT NULL DEFAULT '' COMMENT '客户名称',
  `vc_phone` varchar(11) NOT NULL COMMENT '客户手机号码',
  `vc_uid` varchar(100) NOT NULL DEFAULT '' COMMENT '红圈用户唯一标志，从接口中获取',
  `vc_email` varchar(200) NOT NULL DEFAULT '' COMMENT '客户邮件',
  `vc_realname` varchar(100) NOT NULL DEFAULT '' COMMENT '客户联系人名',
  `vc_entcode` varchar(10) NOT NULL DEFAULT '' COMMENT '客户企业代码',
  `vc_userid` int(11) NOT NULL COMMENT '客户归属销售',
  `vc_contentid` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '分享文案ID',
  `vc_paystatus` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '支付状态，0-未支付；1-支付成功；2-支付失败;3-支付验证失败',
  `vc_openstatus` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '开通状态，0-未开通；1-已开通；2-开通失败',
  `vc_months` mediumint(9) unsigned NOT NULL DEFAULT '0' COMMENT '开通时间（月份）',
  `vc_starttime` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '产品开通开始时间',
  `vc_endtime` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '产品开通结束时间',
  `vc_ptotalcount` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '员工人数，由平台端倒入',
  `ctime` int(11) NOT NULL COMMENT '创建时间',
  `mtime` int(11) NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `vc_phone` (`vc_phone`),
  KEY `vc_contentid` (`vc_contentid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='闭环销售－客户表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `vipcustomer_orders`
--

CREATE TABLE IF NOT EXISTS `vipcustomer_orders` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `vo_ordersn` varchar(100) NOT NULL DEFAULT '' COMMENT '订单号',
  `vo_customerid` int(11) unsigned NOT NULL COMMENT '客户ID',
  `vo_userid` int(11) unsigned NOT NULL COMMENT '销售ID',
  `vo_totalfee` int(11) unsigned NOT NULL COMMENT '总额，精确到分',
  `vo_months` mediumint(9) unsigned NOT NULL COMMENT '开通',
  `vo_discount` tinyint(4) unsigned NOT NULL DEFAULT '100' COMMENT '打折，乘以100',
  `vo_origntotalfee` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '支付总额，精确到分',
  `vo_paystatus` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '支付状态，1-支付成功；2-支付失败；3-支付验证失败',
  `vo_paystatusmsg` varchar(5000) NOT NULL DEFAULT '' COMMENT '支付信息',
  `vo_openstatus` tinyint(4) NOT NULL DEFAULT '-1' COMMENT '开通状态',
  `vo_openstatusmsg` varchar(5000) NOT NULL DEFAULT '' COMMENT '开通状态信息',
  `ctime` int(11) unsigned NOT NULL COMMENT '创建时间',
  `mtime` int(11) NOT NULL DEFAULT '0' COMMENT '更新信息时间',
  PRIMARY KEY (`id`),
  KEY `vo_customerid` (`vo_customerid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='闭环销售订单' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `vipcustomer_paylog`
--

CREATE TABLE IF NOT EXISTS `vipcustomer_paylog` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `vp_orderid` int(11) unsigned NOT NULL COMMENT '订单ID',
  `vp_ordersn` varchar(100) NOT NULL COMMENT '去支付宝支付的订单号',
  `vp_paytime` int(11) unsigned NOT NULL COMMENT '支付时间',
  `vp_totalfee` int(11) unsigned NOT NULL COMMENT '支付钱数，精确到分',
  `vp_returntime` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '返回支付信息时间',
  `vp_returntotalfee` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '返回支付款数，精确到分',
  `vp_status` mediumint(9) unsigned NOT NULL DEFAULT '0' COMMENT '支付状态，1-支付成功；2-支付失败；3－支付验证失败',
  `vp_statusmsg` varchar(5000) NOT NULL DEFAULT '' COMMENT '支付状态信息',
  PRIMARY KEY (`id`),
  KEY `vp_orderid` (`vp_orderid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='闭环销售－支付日志' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `vipcustomer_paylognotify`
--

CREATE TABLE IF NOT EXISTS `vipcustomer_paylognotify` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `vp_orderid` int(11) NOT NULL COMMENT '订单ID',
  `vp_payinfo` varchar(5000) NOT NULL COMMENT '订单支付宝支付备份信息',
  PRIMARY KEY (`id`),
  KEY `vp_orderid` (`vp_orderid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='支付宝支付备份日志信息' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `vipcustomer_sendlog`
--

CREATE TABLE IF NOT EXISTS `vipcustomer_sendlog` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `vs_phone` varchar(11) NOT NULL COMMENT '手机号码',
  `vs_mome` varchar(5000) NOT NULL DEFAULT '' COMMENT '发送请求信息',
  `vs_status` tinyint(4) NOT NULL DEFAULT '-2' COMMENT '发送状态，－2:未发送',
  `vs_statusmsg` varchar(1000) NOT NULL DEFAULT '' COMMENT '发送状态描述',
  `vs_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '1-手机注册码发送；2-开通手机号码用户；3-开通企业代码；4-开通红圈管理产品并发送信息；5-判断手机是否已经被使用;6-判断注册码是否正确',
  `ctime` int(11) unsigned NOT NULL COMMENT '发送时间',
  PRIMARY KEY (`id`),
  KEY `vs_phone` (`vs_phone`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='闭环销售日志表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `vipcustomer_sharecontent`
--

CREATE TABLE IF NOT EXISTS `vipcustomer_sharecontent` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '分享内容ID',
  `vs_userid` int(11) unsigned NOT NULL COMMENT '销售ID，对应于user.id',
  `vs_discount` mediumint(9) unsigned NOT NULL DEFAULT '100' COMMENT '打折，存储的数字为0.5*100',
  `vs_content` varchar(5000) NOT NULL DEFAULT '' COMMENT '分享内容',
  `vs_qrcodepng` varchar(1000) NOT NULL DEFAULT '' COMMENT '二维码文件名',
  `vs_customerid` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '客户ID',
  `ctime` int(11) unsigned NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `vs_userid` (`vs_userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分享内容表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `visitplan` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_cusid` (`cusid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='拜访计划表' AUTO_INCREMENT=314205 ;
...
CREATE TABLE IF NOT EXISTS `visitrecord` (
  ...
  `fvid` int(11) NOT NULL DEFAULT '0' COMMENT '被陪访记录ID',
  `is_renew` tinyint(1) NOT NULL COMMENT '是否属于续签',
  ...
  `next_time` datetime DEFAULT NULL COMMENT '下次拜访时间',
  `next_address` varchar(255) DEFAULT NULL COMMENT '下次拜访地点',
  PRIMARY KEY (`id`),
  KEY `cusid` (`cusid`),
  KEY `subvisit` (`subvisit`),
  KEY `operator` (`operator`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=270410 ;
...
CREATE TABLE IF NOT EXISTS `visitresult` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='拜访记录表' AUTO_INCREMENT=137530 ;
...
CREATE TABLE IF NOT EXISTS `visitresult_photo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=33677 ;
...
CREATE TABLE IF NOT EXISTS `yunying_blankcontract` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `contract_no` (`contract_no`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='运营空白合同' AUTO_INCREMENT=1764 ;
...
CREATE TABLE IF NOT EXISTS `yunying_contract_config` (
  ...
  `flg` int(11) NOT NULL COMMENT '当前最大流水号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='运营合同-合同编号前缀' AUTO_INCREMENT=60 ;
